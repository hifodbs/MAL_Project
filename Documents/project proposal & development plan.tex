...
The project is considered done when all the following conditions are satisfied:

\begin{itemize}
    \item The model is implemented, integrated into the Flask server, and correctly returns predictions to the dashboard.
    ...
    \item Model performance meets the predefined KPIs, such as daily mean MAE below the target threshold.
