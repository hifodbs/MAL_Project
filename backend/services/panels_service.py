...
class PanelsService:
    ...
    def get_all_panel_measurements_by_id_and_time_reange(self, plant_id: str, panel_id: str, end_time: datetime, hours: int):
        return self.measurements_dao.get_panel_measurements_by_panel_id_and_time_range(plant_id=plant_id, panel_id=panel_id, end_time=end_time, hours=hours)
    ...
    def get_all_panel_mesurements_by_plant_id_and_time_renage(self, plant_id: str, end_time: datetime, hours: int):
        return self.measurements_dao.get_panel_measurements_by_plant_id_and_time_range(plant_id=plant_id, end_time=end_time, hours=hours)
